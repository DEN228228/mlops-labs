...
def main():
    ...
    if args.train_size + args.test_size > 1.0:
        raise ValueError("❌ Помилка: Сума train_size та test_size не може перевищувати 1.0")
    ...
    print(f"Розділення на тренувальну ({args.train_size*100:.2f}%) та тестову ({args.test_size*100:.2f}%) вибірки від загального датасету...")
